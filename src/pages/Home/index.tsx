...
import headerphoto from '../../assets/images/hero-image.jpg'

;<div className="flex flex-col  relative    w-[100%] h-[100%]">
  <Content
    style="vector-header    flex items-center justify-center"
    border="vector-header-border"
  >
    <img className=" w-[100%]  " src={headerphoto} />
  </Content>
